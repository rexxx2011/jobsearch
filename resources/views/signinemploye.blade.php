...
@section('body')
	  ...
	  <section>
	  	<form enctype="multipart/form-data" method="post" action="createemploye">
	  		@csrf
	  			...
	  			<div class="row">
	  				<div class="col-md-12 col-lg-8 mb-4">
			              ...
			              <div class="row form-group">
			                  ...
			                  <select name="sc1type" class="col-md-12 mb-3 mb-md-0 form-control">
			                    <option>-----------</option>
			                    <option>CGPA</option>
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                	<input type="text" name="sc1" class="form-control" style="width: 50%;">
			              ...
			              <hr>
			              <div class="row form-group">
			              	<div class="col-md-12 font-weight-bold">Class XIIth </div>
			                <div class="col-md-6 mb-3 mb-md-0">
			                  <select name="sc2type" class="col-md-12 mb-3 mb-md-0 form-control">
			                    <option>-----------</option>
			                    <option>CGPA</option>
			                    <option>Percentage</option>
			                  </select>                  
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                	<input type="text" name="sc2" class="form-control" style="width: 50%;">
			              ...
			              <div class="row form-group">
			              	<div class="col-md-12 font-weight-bold">Class Xth </div>
			                <div class="col-md-6 mb-3 mb-md-0">
			                  <select name="sc3type" class="col-md-12 mb-3 mb-md-0 form-control">
			                    <option>-----------</option>
			                    <option>CGPA</option>
			                    <option>Percentage</option>
			                  </select>                  
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                	<input type="text" name="sc3" class="form-control" style="width: 50%;">
